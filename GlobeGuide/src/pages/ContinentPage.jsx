...
function ContinentPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-navy-900 text-white font-sans">
      ...
      {/* ── HERO HEADER ── */}
      <section className="relative overflow-hidden py-14 px-4 sm:px-6 lg:px-8 border-b border-white/5">
        {/* Background glow */}
        <div
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-64 bg-navy-800 border border-white/10 text-white rounded-xl pl-9 pr-4 py-2.5 text-sm focus:outline-none transition-colors placeholder:text-slate-600"
        ...
        <div className="max-w-7xl mx-auto">
          {loading ? (
            ...
            <div className="text-center py-24">
              ...
              <p className="text-slate-400 text-lg">No countries found for "{search}"</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
              {filtered.map(country => (
                <div
                  key={country.cca3}
                  className="group card-bg rounded-2xl border border-white/8 hover:border-white/20 overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl flex flex-col"
                >
                  {/* Flag */}
                  <div
                  ...
                  <div className="p-5 flex flex-col flex-1 gap-2">
                    <h3 className="font-black text-base text-white mb-1">{country.name.common}</h3>
                      ...
                      <div className="mt-2 pt-2 border-t border-white/5">
                        ...
                        <div className="flex flex-wrap gap-1 mt-1">
                          ...
                          {country.borders.length > 5 && (
                            <span className="text-[10px] text-slate-500">+{country.borders.length - 5}</span>
                          )}
                        </div>
                      </div>
                    )}
